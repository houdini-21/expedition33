      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-3">
          ...
          <Image
            ...
            src={
              user?.image ||
              "https://avatars.githubusercontent.com/u/5075489?v=4"
            }
            alt="User Avatar"
            width={34}
            height={34}
        ...
        >
          ...
          >
            <g>
              <path
                d="M62.666,32.316L57.758,21.53c-0.457-1.007-1.646-1.449-2.648-0.992c-1.006,0.457-1.45,1.644-0.992,2.648l3.365,7.397
		...
		C62.988,33.207,62.901,32.726,62.666,32.316z"
              />
              <path
                d="M51.583,47.577c-1.104,0-2,0.895-2,2v8.006h-11V15.269c0-1.722-0.81-3.25-2.445-3.795L24.536,7.583h25.047v9.994
